    ...
    */
    ...
    public void get11(){
        ...
        response.
                then().
                assertThat().
                statusCode(200).body("meta.pagination.limit",equalTo(10),
        ...
        // 1.Way: I will get all genders in a list then calculate the number of females then compare it with the list.
